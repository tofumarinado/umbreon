...
const AchievementsSection = () => (
  ...
  >
    ...
    <div className="flat-card p-6 print:!p-0 print:!bg-transparent print:!border-none print:!shadow-none rounded-xl space-y-6 print:space-y-3">
      <div>
        <h3 className="text-xs uppercase tracking-widest text-slate-400 font-bold mb-3 print:mb-1 border-b border-slate-700 pb-2 print:pb-1">Certifications</h3>
      ...
      <div>
        <h3 className="text-xs uppercase tracking-widest text-slate-400 font-bold mb-3 print:mb-1 border-b border-slate-700 pb-2 print:pb-1">Awards</h3>
        <ul className="space-y-4 print:space-y-2 mt-3 print:mt-1">
          {resumeData.awards.map((award, i) => (
            <li key={i} className="text-sm flex items-start gap-2 print:break-inside-avoid">
